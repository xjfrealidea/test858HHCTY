...
public:
    ...
    void setupUi(QMainWindow *MagnetMenu)
    {
        if (MagnetMenu->objectName().isEmpty())
            MagnetMenu->setObjectName(QStringLiteral("MagnetMenu"));
        ...
        sreachButton->setObjectName(QStringLiteral("sreachButton"));
        ...
        sreachButton->setStyleSheet(QStringLiteral("font: 75 20pt \"Times New Roman\";"));
        simpleButton = new QPushButton(centralwidget);
        simpleButton->setObjectName(QStringLiteral("simpleButton"));
        ...
        mappedButton->setObjectName(QStringLiteral("mappedButton"));
        ...
        setupButton->setStyleSheet(QStringLiteral("selection-background-color: rgb(255, 255, 127);"));
...
""));
        ...
        controlHint->setObjectName(QStringLiteral("controlHint"));
        ...
        controlHint->setStyleSheet(QStringLiteral("font: 75 22pt \"Times New Roman\";"));
        controlHint->setAlignment(Qt::AlignCenter);
        controlHint->setWordWrap(true);
        lcdTimeLabel = new DigitalClock(centralwidget);
        lcdTimeLabel->setObjectName(QStringLiteral("lcdTimeLabel"));

...
QT_MOC_LITERAL(1, 9, 10), // "enterPress"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 8) // "escPress"

    },
    "timeEdit\0enterPress\0\0escPress"
};
...
void timeEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        timeEdit *_t = static_cast<timeEdit *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->enterPress(); break;
        case 1: _t->escPress(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (timeEdit::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&timeEdit::enterPress)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (timeEdit::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&timeEdit::escPress)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject timeEdit::staticMetaObject = {
    { &QDateTimeEdit::staticMetaObject, qt_meta_stringdata_timeEdit.data,
      qt_meta_data_timeEdit,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void timeEdit::enterPress()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void timeEdit::escPress()
{

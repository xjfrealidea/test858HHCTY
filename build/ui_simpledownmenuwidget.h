...
public:
    ...
    void setupUi(QWidget *SimpleDownMenuWidget)
    {
        if (SimpleDownMenuWidget->objectName().isEmpty())
            SimpleDownMenuWidget->setObjectName(QStringLiteral("SimpleDownMenuWidget"));
        SimpleDownMenuWidget->resize(647, 224);
        nextMarkDataLabel = new QLabel(SimpleDownMenuWidget);
        nextMarkDataLabel->setObjectName(QStringLiteral("nextMarkDataLabel"));
        ...
        nextLineLabel->setObjectName(QStringLiteral("nextLineLabel"));
        ...
        nextLineDataLabel->setObjectName(QStringLiteral("nextLineDataLabel"));
        ...
        nextMarkLabel->setObjectName(QStringLiteral("nextMarkLabel"));

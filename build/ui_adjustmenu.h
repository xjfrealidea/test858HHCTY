...
public:
    ...
    void setupUi(QWidget *AdjustMenu)
    {
        if (AdjustMenu->objectName().isEmpty())
            AdjustMenu->setObjectName(QStringLiteral("AdjustMenu"));
        AdjustMenu->resize(1000, 576);
        AdjustMenu->setFocusPolicy(Qt::NoFocus);
        masterVolumeLabel = new QLabel(AdjustMenu);
        masterVolumeLabel->setObjectName(QStringLiteral("masterVolumeLabel"));
        ...
        wooweeLabel->setObjectName(QStringLiteral("wooweeLabel"));
        ...
        wooweeVolumeLabel->setObjectName(QStringLiteral("wooweeVolumeLabel"));
        ...
        wooweeSensitivityLabel->setObjectName(QStringLiteral("wooweeSensitivityLabel"));
        ...
        qcWarningLabel->setObjectName(QStringLiteral("qcWarningLabel"));
        ...
        qcWarningVolumeLabel->setObjectName(QStringLiteral("qcWarningVolumeLabel"));
        ...
        qcWarningLevelLabel->setObjectName(QStringLiteral("qcWarningLevelLabel"));
        ...
        fullScaleLabel->setObjectName(QStringLiteral("fullScaleLabel"));
        ...
        rdngsScreenLabel->setObjectName(QStringLiteral("rdngsScreenLabel"));
        ...
        wooweeSensitivityUnitLabel->setObjectName(QStringLiteral("wooweeSensitivityUnitLabel"));
        ...
        qcWarningLevelUnitLabel->setObjectName(QStringLiteral("qcWarningLevelUnitLabel"));
        ...
        fullScaleUnitLabel->setObjectName(QStringLiteral("fullScaleUnitLabel"));
        ...
        editLineMarkLabel->setObjectName(QStringLiteral("editLineMarkLabel"));
        ...
        centerTraceLabel->setObjectName(QStringLiteral("centerTraceLabel"));
